...
class TestFactCheckAgent:
    ...
    @pytest.mark.asyncio
    async def test_check_returns_result(self, config, mock_client, tracker, sample_answer, sample_chunks):
    ...
    @pytest.mark.asyncio
    async def test_check_detects_verified(self, config, mock_client, tracker, sample_answer, sample_chunks):
        from documind.client import CompletionResponse
        mock_client.chat_completion.return_value = CompletionResponse(
    ...
    @pytest.mark.asyncio
    async def test_run_method(self, config, mock_client, tracker, sample_answer, sample_chunks):
        from documind.client import CompletionResponse
        mock_client.chat_completion.return_value = CompletionResponse(
